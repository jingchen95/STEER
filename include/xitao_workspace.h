...
namespace xitao {   
  ...
  extern bool ptt_full;
  extern float average[NUMSOCKETS][XITAO_MAXTHREADS];
  ...
  extern int steal_DtoA;
  extern int D_give_A;
  extern int best_cluster_config;
  extern int second_best_cluster_config;
  extern int best_width_config[NUMSOCKETS];
  extern int best_leader_config[NUMSOCKETS];
  extern float best_power_config[NUMSOCKETS];
  extern float best_perf_config[NUMSOCKETS];
#endif
